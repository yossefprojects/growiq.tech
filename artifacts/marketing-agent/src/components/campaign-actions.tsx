        ...
        <div className="flex flex-wrap gap-2">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent className="w-60">
              ...
              <DropdownMenuItem onClick={() => shareText("pinterest")}>
              ...
              <DropdownMenuItem onClick={() => shareText("reddit")}>
              ...
              <DropdownMenuItem onClick={() => shareText("whatsapp")}>
                <MessageCircle className="w-4 h-4 mr-2 text-[#25D366]" /> WhatsApp
              </DropdownMenuItem>
              <DropdownMenuItem onClick={() => shareText("telegram")}>
