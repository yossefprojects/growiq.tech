# Prompt Replit — Refonte complète TOUT le site growiq.tech
# Design moderne, animé, sophistiqué — palette IA / SaaS premium

## Contexte

GrowIQ est un agent marketing IA en français pour les indépendants et PME.
Il crée, programme et publie des campagnes (Facebook, Instagram, LinkedIn,
emails, pubs payantes) depuis une simple conversation.

**Couleur actuelle** : `#5b54d6` violet/indigo générique SaaS.
**Nouvelle identité** : violet profond + magenta accent + noir quasi-absolu.
Ce n'est plus un SaaS générique — c'est un agent IA premium, moderne,
un peu comme Linear ou Vercel mais avec une énergie marketing.

## Règle principale
Les fonctionnalités de l'app (`/app`) ne changent pas.
On redesigne la landing page, la navbar, le footer, et les pages statiques.
...
:root {
  ...
  --void:      #08080F;   /* noir quasi-absolu pour les fonds sombres */
  --deep:      #0F0F1A;   /* fond sections sombres */
  --purple:    #5B54D6;   /* violet principal (conservé) */
  --purple2:   #7B74E8;   /* violet clair */
  --magenta:   #C026D3;   /* accent magenta/fuchsia */
  --cyan:      #06B6D4;   /* accent cyan */
  --white:     #FFFFFF;
  --bg:        #FAFAFA;   /* fond clair neutre */
  --text:      #0F0F1A;   /* texte principal */
  ...
  return (
    <nav style={{
      ...
      <a href="/" style={{
        ...
        {/* Icône IA — carré avec gradient + éclair */}
        <div style={{
...
function HeroSection() {
  // Effet typewriter sur les exemples de campagnes
  const examples = [
  ...
  return (
    <section style={{
      ...
      <div style={{
        ...
        backgroundImage: `
          linear-gradient(rgba(91,84,214,0.04) 1px, transparent 1px),
          linear-gradient(90deg, rgba(91,84,214,0.04) 1px, transparent 1px)
        `,
      ...
      <div style={{
        ...
        <div style={{
          ...
          <span style={{
            fontSize: 11, fontWeight: 700, color: '#7B74E8',
        ...
        <p style={{
          ...
          GrowIQ crée, programme et publie tes posts, emails et pubs
          à ta place — en moins de 10 minutes. Sans agence. En français.
        </p>
        ...
        <div style={{
          ...
          <span style={{
            fontSize: 14, color: 'white', fontStyle: 'italic',
...
## 3 — SECTION "À QUI S'ADRESSE GROWIQ ?"
...
function AudienceCard({ target, delay }) {
...
function StatsSection() {
  ...
  const stats = [
    ...
    { end: 10, suffix: '×', label: 'plus de contenu publié', prefix: 'jusqu\'à ' },
      ...
      <div style={{
        ...
        {stats.map((s, i) => (
          <div key={i} style={{ textAlign: 'center' }}>
            <div style={{
              fontSize: 44, fontWeight: 900, color: '#7B74E8',
...
function FAQSection() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: 'Oui. Tes informations restent privées et tu peux supprimer ton compte et toutes tes données en un clic depuis ton espace.',
    },
    {
            ...
            <div key={i} className="reveal" style={{ transitionDelay: `${i * 0.06}s` }}>
              <div style={{
                ...
                >
                  ...
                  <span style={{
                    fontSize: 18, color: '#5B54D6', flexShrink: 0, marginLeft: 16,
    ...
    <section style={{
      ...
      <div style={{ maxWidth: 800, margin: '0 auto', textAlign: 'center' }}>
        <div className="reveal" style={{
          ...
          border: '1px solid rgba(91,84,214,0.25)',
          borderRadius: 28, padding: 'clamp(48px, 6vw, 80px) clamp(24px, 5vw, 80px)',
          position: 'relative', overflow: 'hidden',
        }}>
          {/* Glow */}
          <div style={{
          ...
          <div style={{ position: 'relative', zIndex: 1 }}>
            ...
            <p style={{
              ...
              Rejoins des milliers d'indépendants et de petites entreprises
              qui économisent des heures chaque semaine avec GrowIQ.
            </p>

            <a href="/app" style={{
              background: 'linear-gradient(135deg, #5B54D6, #C026D3)',
              color: 'white', borderRadius: 50,
              padding: '15px 44px', fontSize: 17, fontWeight: 800,
              textDecoration: 'none',
...
function Footer() {
  return (
    <footer style={{ background: '#08080F' }}>
      {/* Ligne gradient */}
      <div style={{
        height: 1, margin: '0 clamp(16px, 5vw, 48px)',
      ...
      <div style={{
        ...
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 14 }}>
            <div style={{
              ...
              background: 'linear-gradient(135deg, #5B54D6, #C026D3)',
              display: 'flex', alignItems: 'center', justifyContent: 'center',
              fontSize: 14, boxShadow: '0 4px 12px rgba(91,84,214,0.4)',
            }}>⚡</div>
            <span style={{
          ...
          <p style={{
            ...
            L'agent marketing IA en français. Crée, programme et publie
            tes campagnes en quelques minutes.
          </p>
          {/* Réseaux sociaux */}
          <div style={{ display: 'flex', gap: 8 }}>
            {[
              ...
              onMouseEnter={e => {
                e.currentTarget.style.borderColor = 'rgba(91,84,214,0.5)'
                e.currentTarget.style.background = 'rgba(91,84,214,0.1)'
              }}
              onMouseLeave={e => {
        ...
        <div>
          ...
          {['Fonctionnalités', 'Tarifs', 'Lancer une campagne', 'Mon compte'].map(l => (
            <a key={l} href="#" style={{
            ...
            onMouseEnter={e => e.target.style.color = '#7B74E8'}
      ...
      <div style={{
        ...
        padding: '16px clamp(16px, 5vw, 48px)', textAlign: 'center',
      }}>
        <p style={{ fontSize: 11, color: 'rgba(255,255,255,0.18)' }}>
          © 2025 GrowIQ · growiq.tech · Agent marketing IA en français
        </p>
      </div>
    </footer>
  )
...
## RÉCAPITULATIF DES EFFETS VISUELS

| Effet | Où | Technique |
|---|---|---|
| Effet typewriter | Hero — exemples de campagnes | useState + useEffect chaîné |
| Titre shimmer gradient | Titre hero | background-clip + animation |
| Grille de fond | Hero | background-image repeating |
| Glows ambiants | Hero, stats, CTA final | radial-gradient position absolute |
| Particules flottantes | Hero | float animation + icônes emoji |
| Navbar glassmorphism | Header au scroll | backdrop-filter + borderColor scroll |
| Scroll reveal progressif | Toutes les sections | IntersectionObserver + .visible |
| Hover dark mode | Cartes audience, features, étapes | state local + transform translateY |
| Barre gradient au hover | Cartes audience | width 0→100% transition |
| Numéros watermark | Section "Comment ça marche" | opacity 6% en position absolute |
| Compteurs animés | Section stats | IntersectionObserver + countUp |
| Accordion FAQ | Section FAQ | open state + height auto |
| CTA hover lift | Tous les CTAs | translateY(-2px) + glow intensifié |
